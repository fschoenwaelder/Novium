...
| bin_to_dec(binaryNumber number | string) float64 | Transforms the input binary number into a decimal format | **`bin_to_dec("0b1010")bin_to_dec(1010)`** | **`10`** |
...
| date_time(dateTimeFormat string, optionalUnixTime interface) string | Returns the formatted date time using simplified or **`go`** style layout for the current or the given unix time | **`date_time("%Y-%M-%D %H:%m")date_time("%Y-%M-%D %H:%m", 1654870680)date_time("2006-01-02 15:04", unix_time())`** | **`2022-06-10 14:18`** |
...
| hex_to_dec(hexNumber number | string) float64 | Transforms the input hexadecimal number into decimal format | **`hex_to_dec("ff")hex_to_dec("0xff")`** | **`255`** |
